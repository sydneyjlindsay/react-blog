        ...
        return (
            <div>
                <form onSubmit={this.submitBlog}>
                    <input type='text' ref='blogTitle' placeholder='Title' /><br/>
                    <select ref='blogCategory'> {chooseCategory}></select>
                    <br/>
                    <textarea ref='blogText' placeholder="Enter text"></textarea><br/>
